...
```{r}
MakeDatabase<-'C:\\Users\\mspoto\\Desktop\\GuideFinderFolder\\GuideFinder-Windows\\makeblastdb.exe -in mutansexamplefastafile.txt -dbtype nucl -out GenomeDatabase'
RunBlast<-'C:\\Users\\mspoto\\Desktop\\GuideFinderFolder\\GuideFinder-Windows\\blastn.exe -task blastn-short -query BLASTguides.fasta -db GenomeDatabase -outfmt 6 -num_threads 4 -dust no -soft_masking false -max_target_seqs 5 -word_size 13 -out MatchGuides.blast'
```
...
```{r,tidy=TRUE}
Re_RunBlast<-'C:\\Users\\mspoto\\Desktop\\GuideFinderFolder\\GuideFinder-Windows\\blastn.exe -task blastn-short -query re_BLASTguides.fasta -db GenomeDatabase -outfmt 6 -num_threads 4 -dust no -soft_masking false -max_target_seqs 5 -word_size 13 -out re_MatchGuides.blast'
#If selecting optio to relax off-target searches 
Re_RunBlast_Lowered<-'C:\\Users\\mspoto\\Desktop\\GuideFinderFolder\\GuideFinder-Windows\\blastn.exe -task blastn-short -query re_BLASTguides.fasta -db GenomeDatabase -outfmt 6 -num_threads 4 -dust no -soft_masking false -max_target_seqs 5 -word_size 14 -out re_MatchGuides.blast'
