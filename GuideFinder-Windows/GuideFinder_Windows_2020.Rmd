...
```{r setup}
knitr::opts_knit$set(root.dir = '\\Users\\mspoto\\Desktop\\Test')
setwd('\\Users\\mspoto\\Desktop\\Test')
```
...
BiocManager::install(c("Biostrings", "genbankr","annotate","stringr","data.table","seqinr","ape","refGenome","rentrez","reshape2","purrr","stringi", "tidyr"))
...
suppressPackageStartupMessages(library(refGenome)) # this may not be downloadable
...
# pivot_longer(c(-dist), names_to="dist2", values_to="value") 
...
MakeDatabase<-' __C:\\Users\\mspoto\\Desktop\\GuideFinderFolder\\GuideFinder-Windows\\makeblastdb.exe__ -in __mutansexamplefastafile.txt__ -dbtype nucl -out GenomeDatabase'

RunBlast<-RunBlast<-'C:\\Users\\mspoto\\Desktop\\GuideFinderFolder\\GuideFinder-Windows\\blastn.exe -task blastn-short -query BLASTguides.fasta -db GenomeDatabase -outfmt 6 -num_threads 4 -dust no -soft_masking false -max_target_seqs 5 -word_size 13 -out MatchGuides.blast' 
...
```{r}
MakeDatabase<-'C:\\Users\\mspoto\\Desktop\\Test\\makeblastdb.exe -in concatenatedfastafile.txt -dbtype nucl -out GenomeDatabase'

RunBlast<-'C:\\Users\\mspoto\\Desktop\\Test\\blastn.exe -task blastn-short -query BLASTguides.fasta -db GenomeDatabase -outfmt 6 -num_threads 4 -dust no -soft_masking false -max_target_seqs 5 -word_size 13 -out MatchGuides.blast'


ScrambleBlast<-'C:\\Users\\mspoto\\Desktop\\Test\\blastn.exe -task blastn-short -query BLASTscrambles.fasta -db GenomeDatabase -outfmt 6 -num_threads 4 -dust no -soft_masking false -max_target_seqs 5 -word_size 11 -perc_identity .9 -out MatchScrambles.blast'
...
Re_RunBlast<-'C:\\Users\\mspoto\\Desktop\\Test\\blastn.exe -task blastn-short -query re_BLASTguides.fasta -db GenomeDatabase -outfmt 6 -num_threads 4 -dust no -soft_masking false -max_target_seqs 5 -word_size 13 -out re_MatchGuides.blast'
#If selecting optio to relax off-target searches 
Re_RunBlast_Lowered<-'C:\\Users\\mspoto\\Desktop\\Test\\blastn.exe -task blastn-short -query re_BLASTguides.fasta -db GenomeDatabase -outfmt 6 -num_threads 4 -dust no -soft_masking false -max_target_seqs 5 -word_size 14 -out re_MatchGuides.blast'
...
# Then, in this section, run this chunk of code (currently commented out), INSTEAD of the above 
