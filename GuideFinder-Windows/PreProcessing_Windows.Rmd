...
knitr::opts_knit$set(root.dir = 'C:/Users/mspoto/Desktop/')
```
...
MakeDatabase<-' __C:\\Users\\mspoto\\Desktop\\GuideFinderFolder\\GuideFinder-Windows\\makeblastdb.exe__ -in __concatenatedfastafile.txt__ -dbtype nucl -out GenomeDatabaseEpi';replace "concatenatedfastafile.txt" if you have a different file than created above.  
...
RunBlast<-' __C:\\Users\\mspoto\\Desktop\\GuideFinderFolder\\GuideFinder-Windows\\blastn.exe__ -task megablast -query __staphaureusexample_codingseq.fasta__ -db GenomeDatabaseEpi -outfmt 6 -num_threads 4 -dust no -soft_masking false -max_target_seqs 1 -perc_identity 100 -out GenesMatch.blast'; replace "staphaureusexample_codingseq.fasta" with the name of your coding sequence file.   
...
MakeDatabase<-'C:\\Users\\mspoto\\Desktop\\GuideFinderFolder\\GuideFinder-Windows\\makeblastdb.exe -in concatenatedfastafile.txt -dbtype nucl -out GenomeDatabaseEpi'

#Input CDS file
CDS<- readDNAStringSet("staphaureusexample_codingseq.fasta", use.names = TRUE)
RunBlast<-'C:\\Users\\mspoto\\Desktop\\GuideFinderFolder\\GuideFinder-Windows\\blastn.exe -task megablast -query staphaureusexample_codingseq.fasta -db GenomeDatabaseEpi -outfmt 6 -num_threads 4 -dust no -soft_masking false -max_target_seqs 1 -perc_identity 100 -out GenesMatch.blast'
