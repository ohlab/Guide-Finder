...
MakeDatabase<-'.\\Guide.Finder.WINDOWS\\makeblastdb.exe -in concatenatedfastafile.txt -dbtype nucl -out GenomeDatabaseEpi'

#Input CDS file
CDS<- readDNAStringSet("staphaureusexample_codingseq.fasta", use.names = TRUE)
RunBlast<-'.\\Guide.Finder.WINDOWS\\blastn.exe -task megablast -query staphaureusexample_codingseq.fasta -db GenomeDatabaseEpi -outfmt 6 -num_threads 4 -dust no -soft_masking false -max_target_seqs 1 -perc_identity 100 -out GenesMatch.blast'
