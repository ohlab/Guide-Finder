...
```{r, eval=FALSE, echo=FALSE}
fastafile<-read.fasta(file="concatenatedfastafile.txt", as.string = TRUE) #read in fasta file
...
MakeDatabase<-' __C:\\Users\\mspoto\\Desktop\\r\\GuideFinder-Windows\\makeblastdb.exe__ -in concatenatedfastafile.txt -dbtype nucl -out GenomeDatabaseEpi' ; replace "concatenatedfastafile.txt" if you have a different file than created above. 
...
RunBlast<-' __C:\\Users\\mspoto\\Desktop\\GuideFinderFolder\\GuideFinder-Windows\\blastn.exe__ -task megablast -query staphaureusexample_codingseq.fasta -db GenomeDatabaseEpi -outfmt 6 -num_threads 4 -dust no -soft_masking false -max_target_seqs 1 -perc_identity 100 -out GenesMatch.blast'
...
MakeDatabase<-'C:\\Users\\mspoto\\Desktop\\r\\GuideFinder-Windows\\makeblastdb.exe -in concatenatedfastafile.txt -dbtype nucl -out GenomeDatabaseEpi'
